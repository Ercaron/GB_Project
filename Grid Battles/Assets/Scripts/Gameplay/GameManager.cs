...
public class GameManager : MonoBehaviour //https://youtu.be/4I0vonyqMi8?t=296 Este vid nos puede facilitar la existencia para organizar. < EL VOLUMEN
{
    ...
    void Start()
    {
        ...
        _placer.UnitPlaced += UnitPlaced;     //osea subscribir un manager que se encargue de placear unidades al evento de OnGameStateChange y
    ...
    {
        UIManager.instance.SetMapUnits(_levelUnits);
